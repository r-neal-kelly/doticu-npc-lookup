...
namespace doticu_npcl { namespace MCM {
    ...
    void Static_Bases_t::On_Config_Open()
    {
        List()->do_update_items = true;
    }

    void Static_Bases_t::On_Config_Close()
    {
        List()->Clear();
    }

    void Static_Bases_t::On_Page_Open(Bool_t is_refresh, Latent_Callback_i* lcallback)
    {
    ...
    void Static_Bases_t::On_Option_Select(Int_t option, Latent_Callback_i* lcallback)
    {
        View_e current_view = Current_View();
    ...
    void Static_Bases_t::On_Option_Menu_Open(Int_t option, Latent_Callback_i* lcallback)
    {
        View_e current_view = Current_View();
    ...
    void Static_Bases_t::On_Option_Menu_Accept(Int_t option, Int_t idx, Latent_Callback_i* lcallback)
    {
        View_e current_view = Current_View();
    ...
    void Static_Bases_t::On_Option_Slider_Open(Int_t option, Latent_Callback_i* lcallback)
    {
        View_e current_view = Current_View();
    ...
    void Static_Bases_t::On_Option_Slider_Accept(Int_t option, Float_t value, Latent_Callback_i* lcallback)
    {
        View_e current_view = Current_View();
    ...
    void Static_Bases_t::On_Option_Input_Accept(Int_t option, String_t value, Latent_Callback_i* lcallback)
    {
        View_e current_view = Current_View();
    ...
    void Static_Bases_t::On_Option_Keymap_Change(Int_t option, Int_t key, String_t conflict, String_t mod, Latent_Callback_i* lcallback)
    {
        View_e current_view = Current_View();
    ...
    void Static_Bases_t::On_Option_Default(Int_t option, Latent_Callback_i* lcallback)
    {
        View_e current_view = Current_View();
    ...
    void Static_Bases_t::On_Option_Highlight(Int_t option, Latent_Callback_i* lcallback)
    {
        View_e current_view = Current_View();
...
namespace doticu_npcl { namespace MCM {
    ...
    Bool_t              Static_Bases_List_t::do_update_items    = true;
    Vector_t<Item_t>    Static_Bases_List_t::read               = Vector_t<Item_t>();
    Vector_t<Item_t>    Static_Bases_List_t::write              = Vector_t<Item_t>();
    Vector_t<Item_t>*   Static_Bases_List_t::items              = nullptr;

    String_t Static_Bases_List_t::Title(Int_t item_count, Int_t page_index, Int_t page_count)
    {
        std::string items =
            std::string("Static Bases: ") +
    ...
    Item_t Static_Bases_List_t::Option_To_Item(Int_t option)
    {
    ...
    void Static_Bases_List_t::Clear()
    {
    ...
    void Static_Bases_List_t::On_Option_Menu_Open(Int_t option, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_List_t::On_Option_Menu_Accept(Int_t option, Int_t idx, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_List_t::On_Option_Slider_Open(Int_t option, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_List_t::On_Option_Slider_Accept(Int_t option, Float_t value, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_List_t::On_Option_Input_Accept(Int_t option, String_t value, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_List_t::On_Option_Keymap_Change(Int_t option, Int_t key, String_t conflict, String_t mod, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_List_t::On_Option_Default(Int_t option, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_List_t::On_Option_Highlight(Int_t option, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }
...
namespace doticu_npcl { namespace MCM {
    ...
    Vector_t<Item_t>* Static_Bases_Filter_t::Execute(Vector_t<Item_t>* read, Vector_t<Item_t>* write)
    {
    ...
    void Static_Bases_Filter_t::Clear()
    {
        Mod_Argument("");
        Mod_Do_Negate(false);
    ...
    Vector_t<String_t> Static_Bases_Filter_t::Selectable_Mods()
    {
        return Mod_Selectables_t<Static_Bases_Base_t, Item_t>().Results();
    }

    Vector_t<String_t> Static_Bases_Filter_t::Selectable_Races()
    {
        return Race_Selectables_t<Static_Bases_Base_t, Item_t>().Results();
    }

    Vector_t<String_t> Static_Bases_Filter_t::Selectable_Bases()
    {
        return Base_Selectables_t<Static_Bases_Base_t, Item_t>().Results();
    }

    Vector_t<String_t> Static_Bases_Filter_t::Selectable_Relations()
    {
        return Relation_Selectables_t<Static_Bases_Base_t, Item_t>(Consts_t::Skyrim_Player_Actor_Base()).Results();
    }
    ...
    void Static_Bases_Filter_t::On_Option_Slider_Open(Int_t option, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_Filter_t::On_Option_Slider_Accept(Int_t option, Float_t value, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }
    ...
    void Static_Bases_Filter_t::On_Option_Keymap_Change(Int_t option, Int_t key, String_t conflict, String_t mod, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_Filter_t::On_Option_Default(Int_t option, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_Filter_t::On_Option_Highlight(Int_t option, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }
...
namespace doticu_npcl { namespace MCM {
    ...
    void Static_Bases_Options_t::On_Option_Menu_Open(Int_t option, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_Options_t::On_Option_Menu_Accept(Int_t option, Int_t idx, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_Options_t::On_Option_Slider_Open(Int_t option, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_Options_t::On_Option_Slider_Accept(Int_t option, Float_t value, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_Options_t::On_Option_Input_Accept(Int_t option, String_t value, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_Options_t::On_Option_Keymap_Change(Int_t option, Int_t key, String_t conflict, String_t mod, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_Options_t::On_Option_Default(Int_t option, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_Options_t::On_Option_Highlight(Int_t option, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }
...
namespace doticu_npcl { namespace MCM {
    ...
    V::Int_Variable_t*  Static_Bases_Item_t::Static_Form_ID_Variable()          { DEFINE_INT("p_item_static_form_id"); }
    ...
    void Static_Bases_Item_t::On_Option_Menu_Open(Int_t option, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_Item_t::On_Option_Menu_Accept(Int_t option, Int_t idx, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_Item_t::On_Option_Slider_Open(Int_t option, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_Item_t::On_Option_Slider_Accept(Int_t option, Float_t value, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_Item_t::On_Option_Input_Accept(Int_t option, String_t value, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_Item_t::On_Option_Keymap_Change(Int_t option, Int_t key, String_t conflict, String_t mod, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }

    void Static_Bases_Item_t::On_Option_Default(Int_t option, Latent_Callback_i* lcallback)
    {
        Main_t::Self()->Destroy_Latent_Callback(lcallback);
    }
