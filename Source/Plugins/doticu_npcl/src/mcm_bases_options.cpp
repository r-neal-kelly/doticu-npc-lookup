...
namespace doticu_npcl { namespace MCM {
    ...
    V::Int_Variable_t*  Bases_Options_t::Uncombative_Spawns_Option_Variable()   { DEFINE_INT_VARIABLE("p_options_uncombative_spawns_option"); }
    V::Bool_Variable_t* Bases_Options_t::Do_Uncombative_Spawns_Variable()       { DEFINE_BOOL_VARIABLE("p_options_do_uncombative_spawns"); }
    ...
    Bool_t Bases_Options_t::Do_Uncombative_Spawns()
    {
        return Do_Uncombative_Spawns_Variable()->Value();
    }

    void Bases_Options_t::Do_Uncombative_Spawns(Bool_t value)
    {
