...
namespace doticu_npcl { namespace MCM {
    ...
    V::Int_Variable_t*  References_Options_t::Back_Option_Variable()            { DEFINE_INT_VARIABLE("p_options_back_option"); }
    V::Int_Variable_t*  References_Options_t::Reset_Option_Variable()           { DEFINE_INT_VARIABLE("p_options_reset_option"); }
    
    V::Int_Variable_t*  References_Options_t::Smart_Select_Option_Variable()    { DEFINE_INT_VARIABLE("p_options_smart_select_option"); }
    V::Bool_Variable_t* References_Options_t::Do_Smart_Select_Variable()        { DEFINE_BOOL_VARIABLE("p_options_do_smart_select"); }
